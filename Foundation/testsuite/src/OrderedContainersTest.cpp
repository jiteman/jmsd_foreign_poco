...
OrderedContainersTest::OrderedContainersTest(): CppUnit::TestFixture()
{
}
...
void OrderedContainersTest::testRangeInsert()
{
	...
	assertEqualTyped( int, map.values_container()[1].first, -2);
	assertEqualTyped( int, map.values_container()[1].second, 0);

	for(int i = 10, j = 2; i < nb_values - 5; i++, j++)
	{
		assertEqualTyped( int, map.values_container()[j].first, i);
		assertEqualTyped( int, map.values_container()[j].second, i+1);
	}
...
void OrderedContainersTest::testInsertWithHint()
{
	...
	assertEqualTyped( ( OrderedMap<int, int>::size_type ), map.insert(map.find(2), std::make_pair(5, 4))->first, 5);

	assertEqualTyped( ( OrderedMap<int, int>::size_type ), map.size(), 5);
}
...
void OrderedContainersTest::testEmplace()
{
	...
	assertEqualTyped( ::std::int64_t, it->first, 10 );
...
void OrderedContainersTest::testTryEmplace2()
{
	...
	for(std::size_t i = 0; i < nb_values; i++) {
		...
		assertEqualTyped( ::std::string, it->first, utils::get_key< ::std::string >( i ) );
		assert(it->second == move_only_test(i));
		assertTrue(inserted);
	}
	assertEqualTyped( ( OrderedMap< ::std::string, move_only_test>::size_type ), map.size(), nb_values);
...
void OrderedContainersTest::testTryEmplaceHint()
{
	...
	assertEqualTyped( ( OrderedMap< ::std::int64_t, move_only_test >::size_type ), it->first, 10 );
	assert(it->second == move_only_test(1));
	...
	assertEqualTyped( ( OrderedMap< ::std::int64_t, move_only_test >::size_type ), it->first, 1 );
...
void OrderedContainersTest::testRangeErase()
{
	...
	assertEqualTyped( HMap::size_type, map.size(), 20);
	assertEqualTyped( HMap::size_type, ::std::distance( map.begin(), map.end() ), 20 );

	for(std::size_t i = 0; i < 10; i++) {
		assertEqualTyped( HMap::size_type, map.at( utils::get_key< ::std::string >( i ) ), utils::get_value< ::std::int64_t >( i ) );

		assertEqualTyped(
			HMap::size_type,
			map.at( utils::get_key< ::std::string >( nb_values - 10 + i ) ),
...
void OrderedContainersTest::testRangeEraseSameIterators()
{
	...
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t>::size_type ), map.size(), 100 );

	it_mutable.value() = -100;
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t>::value_type::second_type ), it_const.value(), -100 );
}


void OrderedContainersTest::testUnorderedErase()
{
	OrderedMap<std::int64_t, std::int64_t> map = { {1, 10}, {2, 20}, {3, 30}, {4, 40}, {5, 50}, {6, 60} };
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::size_type ), map.size(), 6 );

	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::size_type ), map.unordered_erase( 3 ), 1 );
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::size_type ), map.size(), 5 );

	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::size_type ), map.unordered_erase( 0 ), 0 );
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::size_type ), map.size(), 5 );
	...
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::size_type ), map.size(), 0 );
}
...
void OrderedContainersTest::testClear()
{
	...
	map.clear();
	assertEqualTyped( HMap::size_type, map.size(), 0 );
	assertEqualTyped( HMap::size_type, ::std::distance( map.begin(), map.end() ), 0 );
...
void OrderedContainersTest::testReverseIterator()
{
	...
	for(auto it = map.rbegin(); it != map.rend(); ++it) {
		assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), it->second, i );
		i--;
	}
...
void OrderedContainersTest::testIteratorArithmetic()
{
	...
	// it += n
	it += 3;
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), it->second, 40 );

	// it + n
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), ( map.cbegin() + 3 )->second, 40 );
	// n + it
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), ( 3 + map.cbegin() )->second, 40 );

	it = map.cbegin() + 4;
	// it -= n
	it -= 2;
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), it->second, 30 );

	// it - n
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), ( it - 1 )->second, 20 );

	it = map.cbegin() + 2;
	it2 = map.cbegin() + 4;
	// it - it
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), it2 - it, 2 );

	// it[n]
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), map.cbegin()[ 2 ].second, 30 );

	it = map.cbegin() + 1;
	// it[n]
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), it[ 2 ].second, 40 );

	it = map.cbegin();
	// it++
	it++;
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), ( it++ )->second, 20 );
	...
	// it--
	it--;
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), ( it-- )->second, 60 );

	it = map.cend();
	// --it
	--it;
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), ( --it )->second, 50 );
}
...
void OrderedContainersTest::testModifyValue()
{
	...
	{
		if(val.first % 2 == 0)
			assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), val.second, -1 );
		else
			assert(val.second != -1);
	}
}
...
void OrderedContainersTest::testAssignOperator()
{
		...
		assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::size_type ), map.size(), 2 );

		map = {{1, 3}, {2, 4}};
		assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::size_type), map.size(), 2 );
		assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), map.at( 1 ), 3 );
		assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), map.at( 2 ), 4 );
...
void OrderedContainersTest::testMoveConstructor()
{
	...
	assertEqualTyped( HMap::size_type, map_move.size(), nb_values*2 );
...
void OrderedContainersTest::testReassignMovedObjectMoveConstructor()
{
	...
	assertEqualTyped( HMap::size_type, map_move.size(), 3 );
	assertEqualTyped( HMap::size_type, map.size(), 0 );
...
void OrderedContainersTest::testAt()
{
	...
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), map.at( 0 ), 10 );
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), map.at( -2 ), 20 );
	try
	{
		map.at(1);
...
void OrderedContainersTest::testEqualRange()
{
	...
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), it_pair.first->second, 10 );
...
void OrderedContainersTest::testAccessOperator()
{
	...
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), map[ 0 ], 10 );
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), map[ -2 ], 20 );
	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::value_type::second_type ), map[ 2 ], std::int64_t() );

	assertEqualTyped( ( OrderedMap< ::std::int64_t, ::std::int64_t >::size_type ), map.size(), 3 );
}
...
void OrderedContainersTest::testHeterogeneousLookups()
{
	...
	assertEqualTyped( ( OrderedMap< ::std::unique_ptr< int >, int, hash_ptr, equal_to_ptr >::size_type ), map.size(), 3 );

	assertEqualTyped( ( OrderedMap< ::std::unique_ptr< int >, int, hash_ptr, equal_to_ptr >::value_type::second_type ), map.at( addr1 ), 4 );
	assertEqualTyped( ( OrderedMap< ::std::unique_ptr< int >, int, hash_ptr, equal_to_ptr >::value_type::second_type ), map.at( addr2 ), 5 );
	try
	{
		map.at(addr_unknown);
		failmsg("must throw");
	...
	assertEqualTyped( ( OrderedMap< ::std::unique_ptr< int >, int, hash_ptr, equal_to_ptr >::size_type ), map.count( addr1 ), 1 );
	assertEqualTyped( ( OrderedMap< ::std::unique_ptr< int >, int, hash_ptr, equal_to_ptr >::size_type ), map.count( addr2 ), 1 );
	assertEqualTyped( ( OrderedMap< ::std::unique_ptr< int >, int, hash_ptr, equal_to_ptr >::size_type ), map.count( addr_unknown ), 0 );

	assertEqualTyped( ( OrderedMap< ::std::unique_ptr< int >, int, hash_ptr, equal_to_ptr >::size_type ), map.erase( addr1 ), 1 );
	assertEqualTyped( ( OrderedMap< ::std::unique_ptr< int >, int, hash_ptr, equal_to_ptr >::size_type ), map.unordered_erase( addr2 ), 1 );
	assertEqualTyped( ( OrderedMap< ::std::unique_ptr< int >, int, hash_ptr, equal_to_ptr >::size_type ), map.erase(addr_unknown), 0 );
	assertEqualTyped( ( OrderedMap< ::std::unique_ptr< int >, int, hash_ptr, equal_to_ptr >::size_type ), map.unordered_erase( addr_unknown ), 0 );

	assertEqualTyped( ( OrderedMap< ::std::unique_ptr< int >, int, hash_ptr, equal_to_ptr >::size_type ), map.size(), 1 );
}
...
void OrderedContainersTest::testEmptyMap()
{
	...
	assertEqualTyped( ( OrderedMap< ::std::string, int >::size_type ), map.size(), 0 );
	assertTrue(map.empty());
	...
	assertEqualTyped( ( OrderedMap< ::std::string, int >::size_type ), map.count( "" ), 0 );
	assertEqualTyped( ( OrderedMap< ::std::string, int >::size_type ), map.count( "test" ), 0 );
	...
	assertEqualTyped( ( OrderedMap< ::std::string, int >::size_type ), map.erase( "test" ), 0 );
...
void OrderedContainersTest::testPrecalculatedHash()
{
	...
	assertEqualTyped( ( OrderedMap< int, int, ::std::hash< int > >::value_type::second_type ), map.find( 3, map.hash_function()( 3 ) )->second, -3 );

	assertTrue(map_const.find(3, map_const.hash_function()(3)) != map_const.end());
	assertEqualTyped( ( OrderedMap< int, int, ::std::hash< int > >::value_type::second_type ), map_const.find( 3, map_const.hash_function()( 3 ) )->second, -3 );
	 ...
	 * at
	 */
	assertEqualTyped( ( OrderedMap< int, int, ::std::hash< int > >::value_type::second_type ), map.at( 3, map.hash_function()( 3 ) ), -3 );
	assertEqualTyped( ( OrderedMap< int, int, ::std::hash< int > >::value_type::second_type ), map_const.at( 3, map_const.hash_function()( 3 ) ), -3 );
	 ...
	 * count
	 */
	assertEqualTyped( ( OrderedMap< int, int, ::std::hash< int > >::size_type ), map.count( 3, map.hash_function()( 3 ) ), 1 );
	assertEqualTyped( ( OrderedMap< int, int, ::std::hash< int > >::size_type ), map_const.count( 3, map_const.hash_function()( 3 ) ), 1 );

	assertTrue(map.hash_function()(2) != map.hash_function()(3));
	assertEqualTyped( ( OrderedMap< int, int, ::std::hash< int > >::size_type ), map.count( 3, map.hash_function()( 2 ) ), 0 );
	...
	assertEqualTyped( ( OrderedMap< int, int, ::std::hash< int > >::value_type::second_type ), it_range.first->second, -3 );
	...
	assertEqualTyped( ( OrderedMap< int, int, ::std::hash< int > >::value_type::second_type ), it_range_const.first->second, -3 );

	it_range = map.equal_range(3, map.hash_function()(2));
	assertTrue(map.hash_function()(2) != map.hash_function()(3));
	assertEqualTyped( ( OrderedMap< int, int, ::std::hash< int > >::size_type ), std::distance( it_range.first, it_range.second ), 0 );

	/**
	 * erase
	 */
	assertEqualTyped( ( OrderedMap< int, int, ::std::hash< int > >::size_type ), map.erase( 3, map.hash_function()( 3 ) ), 1 );

	assertTrue(map.hash_function()(2) != map.hash_function()(4));
	assertEqualTyped( ( OrderedMap< int, int, ::std::hash< int > >::size_type ), map.erase( 4, map.hash_function()( 2 ) ), 0 );
}
