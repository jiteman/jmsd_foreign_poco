...
//TextBufferIteratorTest::TextBufferIteratorTest(const std::string& rName): CppUnit::TestCase(rName)
TextBufferIteratorTest::TextBufferIteratorTest(): CppUnit::TestFixture()
{
}
